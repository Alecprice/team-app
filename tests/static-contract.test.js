...
assert.ok(html.indexOf('./sports.js')<html.indexOf('./sport-content.js'),'sports registry must load before coaching content');
assert.ok(html.indexOf('./sport-content.js')<html.indexOf('./competition-profiles.js'),'coaching content must load before competition profiles/app');
...
assert.ok(sw.includes("'./sport-content.js'"),'service worker must cache sport coaching content');
...
assert.ok(/team-app-live-v1\.10\.1/.test(sw),'cache version not bumped for sport parity content');
