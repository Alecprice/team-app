...
The previous/stale Vercel origin has been removed from Neon Auth. Neon Auth currently has no production trusted origin.
...
- Vercel workspace currently accessible through the connected account: `Tower Defense2`
- Neon project: `team-app`
- Neon Auth production trusted origin: **leave empty until Vercel reports READY**

## Safe order

1. Create the dedicated `Alecprice/team-app` repository.
2. Push this exact `main` branch.
3. Import that repository into a new Vercel project named `team-app`.
...
7. Add only the final canonical Vercel production origin to Neon Auth trusted origins.
